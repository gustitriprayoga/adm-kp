            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Nilai Kerja Praktik</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-left text-sm">
                                        <a href="{{route('nilai.detail', $item->id)}}" class="btn btn-outline-success badge badge-sm bg-gradient-success" type="button">Detail</a>
