<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Mahasiswa Bimbingan</h6>

                <li class="nav-item">
                  <a class="nav-link text-white {{ (Request::is('logbookmhs') ? 'active bg-gradient-primary' : '') }}" href="{{ url('logbookmhs') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white {{ (Request::is('kaprodi/laporankp/index') ? 'active bg-gradient-primary' : '') }}" href="{{ url('kaprodi/laporankp/index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                      <span class="material-icons">
                        subject
                        </span>
                ...
                <li class="nav-item">
                  <a class="nav-link text-white  {{ (Request::is('kaprodi/nilaimhs') ? 'active bg-gradient-primary' : '') }}" href="{{ url('kaprodi/nilaimhs') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
