                    ...
                    <div class="card-body">
                      <form  method="POST" action="{{route('registrasi')}}">
                        ...
                        <div class="input-group input-group-outline mb-3">
                          ...
                          <input type="text" class="form-control" name="nama_mhs" id="name"  aria-describedby="name" value="{{ old('name') }}">
                          @error('nama_mhs')
                        ...
                        <div class="input-group input-group-outline mb-3">
                          ...
                          <input type="email" class="form-control" name="email" id="email"  aria-describedby="email-addon" value="{{ old('email') }}">
                          @error('email')
                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                          @enderror
                        </div>
                        ...
                        <div class="text-center">
                          <button type="submit" class="btn btn-lg bg-gradient-dark btn-lg w-100 mt-4 mb-0">Registrasi</button>
                        </div>
                      </form>
                    </div>
